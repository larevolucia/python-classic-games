...
def update_progress(selected_word, guess_progress, key):
...
def check_game_over(selected_word, guess_progress, guess_left):
...
def start_game(selected_word):
    """Start and manage the game."""
    guess_left, guess_progress, guessed_letters = initialize_game(selected_word)
    ...
    while True:
        ...
        if key in selected_word:
            print("The word contains " + key)
            guess_progress = update_progress(selected_word, guess_progress, key)
        else:
        ...
        if check_game_over(selected_word, guess_progress, guess_left):
            break
